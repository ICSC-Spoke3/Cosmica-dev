...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    if (HELMOD_LOAD) {
        ...
        InitialPositions = LoadInitPos(NParts, VERBOSE_LOAD, TRIVIAL);
    ...
    #pragma omp parallel
    {
        ...
        for (int iR=gpu_id; iR<NInitRig ; iR+=NGPUs) {
            ...
            (prop_launch_param.Npart, MIN_DT, MAX_DT, TIMEOUT, dev_QuasiParts, dev_PeriodIndexes, pt, dev_RndStates, dev_maxs, TRIVIAL);
