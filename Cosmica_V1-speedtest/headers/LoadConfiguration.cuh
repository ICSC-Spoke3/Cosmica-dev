...
struct InitialPositions_t LoadInitPos(int, bool, bool);
...
void SaveTxt_part(const char*, int, struct QuasiParticle_t, float, bool);

// Save the rigidities final histogram
void SaveTxt_histo(const char*, int, struct MonteCarloResult_t, bool);
