...
__global__ void GridMax(const float, float*, float*);
...
__global__ void histogram_atomic(const float*, const float*, const float, const float, const int, const unsigned long, float*, int*);
