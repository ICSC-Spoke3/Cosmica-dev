...
if __name__ == "__main__":
    ...
    k0_arr = np.linspace(5e-5, 6e-4, 100)
    ...
    for output_file in output_file_list:
        fname = sorted(glob(output_file + '*.dat'))[-1]
        rmse = evaluate_output(fname, exp_data, lis, plot_path=pjoin(pplots, basename(output_file) + '.png'))
