...
Description:
    This file contains the dictionary of the particles and isotopes that are used in the simulation.

Functions:
    findKey(Check, dict):
        Description:
            This function is used to find the key in a dictionary, given a list of keys to check and the dictionary.
        Parameters:
            Check (list): List of keys to check.
            dict (dict): Dictionary to check.
        Returns:
            list: The value of the key in the dictionary, if it is found, otherwise it returns an empty list.

Variables:
    Isotopes_dict (dict):
        A dictionary containing isotopes information. Each key is a string representing the name of the particle or isotope,
        and the value is a list of tuples. Each tuple contains:
            - Z (float): Atomic number.
            - A (float): Mass number.
            - T0 (float): Energy in GeV/n.
            - Name (str): Name of the isotope.

Usage:
    If no Ion is provided as an argument, it defaults to "Proton".
    The script will print the isotopes information if the Ion is found in Isotopes_dict.
    If the Ion is not found, it will print a warning message.
"""

def findKey(Check,dict):
    """ description: This function is used to find the key in a dictionary, given a list of keys to check and the dictionary.
        Check: list of keys to check
        dict: dictionary to check   
        return: the value of the key in the dictionary, if it is found, otherwise it returns an empty list
    """
...
if __name__ == "__main__":
    """
    This is an example of how to use the findKey function.
    usage: python3 Particle_Library.py <Ion>
    """
    Ion = "Proton"
    if len(sys.argv) > 1:
        Ion = sys.argv[1]
