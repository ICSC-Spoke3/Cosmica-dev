...
#include "SDECoeffs.cuh"
  ...
  __device__ struct DiffusionTensor_t DiffusionTensor_symmetric(unsigned char InitZone, signed char HZone, float r, float th, float phi, float Ek, struct PartDescription_t pt, float GaussRndNumber){
    ...
    */
    ...
    if (HZone<Heliosphere.Nregions){
      ...
      */
      ...
      float3 dK_dr;
      float3 Kh = Diffusion_Tensor_In_HMF_Frame(InitZone,HZone,r,th,beta_(Ek,pt.T0),Rigidity(Ek,pt),GaussRndNumber,dK_dr);
      ...
      // heliosheat ...............................
      KK.rr = Diffusion_Coeff_heliosheat(InitZone, r, th, phi, beta_(Ek, pt.T0), Rigidity(Ek, pt), KK.DKrr_dr);
    }
      */
      
      //////////////////////////////////////////////
      //// New formulation (less mute variable) ////
      //////////////////////////////////////////////
      ...
      */
      ...
      if (IsPolarRegion){
        // polar region
        KK.rr = Kh.y*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth)) + SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth)) * (Kh.x*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) + Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))));
        KK.tt = Kh.y*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth)) + SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth)) * (Kh.x*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) + Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))));
        KK.pp = Kh.x*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) + Kh.z*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)));
        KK.tr = SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*(Kh.x*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))+Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))-Kh.y);
        KK.pr = -(Kh.x-Kh.z) *SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth));
        KK.pt = -(Kh.x-Kh.z) *SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth));
      }else{
        // equatorial region. Bth = 0 
        // --> sinZeta = 0 
        // --> cosZeta = +/- 1
        KK.rr =               + SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth)) * (Kh.x*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) + Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))));
        KK.tt = Kh.y*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth)) ;
        KK.pp = Kh.x*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) + Kh.z*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)));
        KK.tr = 0.;
        KK.pr = -(Kh.x-Kh.z) *SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth));
        KK.pt = 0.;
      ...
      */
      ...
      if (IsPolarRegion){
        // polar region
        KK.DKrr_dr = 2. * SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*((   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x+Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))))*SignAsun*( -2.*PolSign/(r) *sqrt( PolSign*PolSign + Bth*Bth)  - PolSign  * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  )/sqrt( PolSign*PolSign + Bth*Bth) )/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth)) + SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*dK_dr.y + SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*(2. * (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x*(- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*(-PolSign*PolSign * PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * PolSign * -2.*PolSign/(r)  + Bth*(-Bth*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * dBth_dr )))/(sqrt( PolSign*PolSign + Bth*Bth) *1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )+(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*dK_dr.x+ SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))* (SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*dK_dr.z+2.*Kh.z*-SignAsun*( PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) *sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) )/sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )/1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) )) + 2.*Kh.y*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*( dBth_dr *sqrt( PolSign*PolSign + Bth*Bth) - Bth * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  )/sqrt( PolSign*PolSign + Bth*Bth) )/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth));
        KK.DKtt_dt = 2. * SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*Kh.y*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth)) + SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth)) * (2.*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x*(- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*(-PolSign*PolSign * - (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW) + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * PolSign * -2.*DelDirac + Bth*(-Bth*- (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW) + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * dBth_dth)))/(sqrt( PolSign*PolSign + Bth*Bth) *1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))  )+2.*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.z*-SignAsun*( - (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * (PolSign*-2.*DelDirac + Bth*dBth_dth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW))/sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))/1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))+2.*((   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x+Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*( dBth_dth*sqrt( PolSign*PolSign + Bth*Bth) - Bth * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth));
        // KK.DKpp_dp = 0. ;
        KK.DKrt_dr = (-Kh.y+(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x+Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))))*(SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*( -2.*PolSign/(r) *sqrt( PolSign*PolSign + Bth*Bth)  - PolSign  * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  )/sqrt( PolSign*PolSign + Bth*Bth) )/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth))    +SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*( dBth_dr *sqrt( PolSign*PolSign + Bth*Bth) - Bth * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  )/sqrt( PolSign*PolSign + Bth*Bth) )/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth))     )+SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*(2.*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x*(- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*(-PolSign*PolSign * PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * PolSign * -2.*PolSign/(r)  + Bth*(-Bth*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * dBth_dr )))/(sqrt( PolSign*PolSign + Bth*Bth) *1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )     +(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*dK_dr.x - dK_dr.y +SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*dK_dr.z    +2.*Kh.z*-SignAsun*( PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) *sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) )/sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )/1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)    ));
        KK.DKtr_dt = (-Kh.y+(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x+Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))))*(SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth))+SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*( dBth_dth*sqrt( PolSign*PolSign + Bth*Bth) - Bth * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth)) )+SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*(2.*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x*(- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*(-PolSign*PolSign * - (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW) + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * PolSign * -2.*DelDirac + Bth*(-Bth*- (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW) + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * dBth_dth)))/(sqrt( PolSign*PolSign + Bth*Bth) *1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))  )                             +2.*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.z*-SignAsun*( - (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * (PolSign*-2.*DelDirac + Bth*dBth_dth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW))/sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))/1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))                  ;
        KK.DKrp_dr = SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth)) * (Kh.z-Kh.x) * SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) * (- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*(-PolSign*PolSign * PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * PolSign * -2.*PolSign/(r)  + Bth*(-Bth*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * dBth_dr )))/(sqrt( PolSign*PolSign + Bth*Bth) *1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )    + (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))  * (Kh.z-Kh.x) *SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) * SignAsun*( -2.*PolSign/(r) *sqrt( PolSign*PolSign + Bth*Bth)  - PolSign  * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  )/sqrt( PolSign*PolSign + Bth*Bth) )/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth)) + (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))* SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))* SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))* (dK_dr.z-dK_dr.x) + (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) * SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*(Kh.z-Kh.x) * -SignAsun*( PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) *sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) )/sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )/1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW);//-----------qui
        // KK.DKpr_dp = 0. ;
        KK.DKtp_dt = (Kh.z - Kh.x) * (SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*(- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*(-PolSign*PolSign * - (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW) + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * PolSign * -2.*DelDirac + Bth*(-Bth*- (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW) + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * dBth_dth)))/(sqrt( PolSign*PolSign + Bth*Bth) *1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))  ) + (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( SignAsun*(          Bth  / sqrt( PolSign*PolSign + Bth*Bth))*PolSign + Bth*Bth))*-SignAsun*( - (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * (PolSign*-2.*DelDirac + Bth*dBth_dth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- (r-rhelio)*Omega* ( -PolSign*( cos(th) *V_SW - sin(th)*DerivativeOfSolarWindSpeed_dtheta(InitZone, HZone, r, th, phi) ) + 2. * sin(th) *V_SW*DelDirac) /(V_SW*V_SW))/sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))/1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) + SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*( dBth_dth*sqrt( PolSign*PolSign + Bth*Bth) - Bth * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth))) );
        // KK.DKpt_dp = 0. ;
      }else{
        // equatorial region. Bth = 0 
        // --> sinZeta = 0 
        ...
        // --> derivative of sinZeta or cosZeta = 0
        KK.DKrr_dr = 2. * SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*((   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x+Kh.z*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))))*SignAsun*( -2.*PolSign/(r) *sqrt( PolSign*PolSign + Bth*Bth)  - PolSign  * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  )/sqrt( PolSign*PolSign + Bth*Bth) )/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth)) +  SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*(2. * (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*Kh.x*(- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*(-PolSign*PolSign * PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * PolSign * -2.*PolSign/(r)  + Bth*(-Bth*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * dBth_dr )))/(sqrt( PolSign*PolSign + Bth*Bth) *1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )+(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*(   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*dK_dr.x+ SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))* (SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))*dK_dr.z+2.*Kh.z*-SignAsun*( PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) *sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) )/sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )/1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) )) ;
        KK.DKtt_dt = 2. * SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*Kh.y*SignAsun*( -2.*DelDirac*sqrt( PolSign*PolSign + Bth*Bth)  - PolSign * (PolSign*-2.*DelDirac + Bth*dBth_dth )/sqrt( PolSign*PolSign + Bth*Bth))/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth)) ;
        // KK.DKpp_dp = 0. ;
        KK.DKrt_dr = 0.;
        KK.DKtr_dt = 0.;
        KK.DKrp_dr = SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth)) * (Kh.z-Kh.x) * SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) * (- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*(-PolSign*PolSign * PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * PolSign * -2.*PolSign/(r)  + Bth*(-Bth*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW)  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * dBth_dr )))/(sqrt( PolSign*PolSign + Bth*Bth) *1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )    + (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))  * (Kh.z-Kh.x) *SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) * SignAsun*( -2.*PolSign/(r) *sqrt( PolSign*PolSign + Bth*Bth)  - PolSign  * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  )/sqrt( PolSign*PolSign + Bth*Bth) )/(sqrt( PolSign*PolSign + Bth*Bth)*sqrt( PolSign*PolSign + Bth*Bth)) + (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))* SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))* SignAsun*(         - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)))* (dK_dr.z-dK_dr.x) + (   sqrt( PolSign*PolSign + Bth*Bth)  / sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW))) * SignAsun*(            PolSign / sqrt( PolSign*PolSign + Bth*Bth))*(Kh.z-Kh.x) * -SignAsun*( PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) *sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) - - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW) * (PolSign*-2.*PolSign/(r)  + Bth*dBth_dr  + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*PolSign *(r-2.*rhelio)*(Omega*sin(th))/(r*V_SW) )/sqrt(1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)) )/1 + Bth*Bth + - PolSign*((Omega*(r-rhelio)*sin(th))/V_SW)*- PolSign*((Omega*(r-rhelio)*sin(th))/V_SW);//-----------qui
  ...
  /* * description:  ========== Decomposition of Diffusion Tensor ====== 
    ...
    */
    ...
    ///////////////////////////
  __device__ struct vect3D_t AdvectiveTerm(unsigned char InitZone,signed char HZone, struct DiffusionTensor_t K, float r, float th, float phi, float Ek, struct PartDescription_t pt){
      struct vect3D_t AdvTerm;
      if (HZone<Heliosphere.Nregions) {
          // inner Heliosphere .........................
          float sintheta=sin(th);
          ...
          // drift component
          struct vect3D_t v_drift = Drift_PM89(InitZone, HZone, r, th, phi, Ek, pt);
          AdvTerm.r   += - v_drift.r  ;
    ...
    //..... Energy loss term   .....................................
    ////////////////////////////////////////////////////////////////
  __device__ float EnergyLoss(unsigned char InitZone, signed char HZone, float r, float th, float phi, float Ek, float T0) {
      if (HZone<Heliosphere.Nregions) {
          // inner Heliosphere .........................
          return 2./3.*SolarWindSpeed(InitZone, HZone, r, th, phi)/r * (Ek + 2.*T0)/(Ek + T0) * Ek;
      }
