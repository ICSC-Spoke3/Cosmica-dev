...
typedef struct HeliosphereZoneProperties_t {                                                     // properties related to heliosphere like dimension, coefficients
...
typedef struct HeliosheatProperties_t {                                                       // properties related to heliopause
    float V0=0;                                                         // [AU/s] Radial Solar wind speed on ecliptic
    float k0=0;                                                         // Diffusion parameter for parallel term of diffusion tensor
} HeliosheatProperties_t;  

typedef struct SimulatedHeliosphere_t {                                                     // properties related to heliosphere like dimension, coefficients
